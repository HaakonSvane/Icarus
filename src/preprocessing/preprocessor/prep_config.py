...
HOURS_AHEAD = 6.5 * 1       # Hours ahead used to determine the label points.
HOURS_BEHIND = HOURS_AHEAD  # Hours behind used in normalization.
THRESH_BUY = 0.010          # Threshold for determining a buy point.
THRESH_SELL = 0.010         # Threshold for determining a sell point.
